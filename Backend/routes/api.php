...
Route::get('/flexibleDashboard/{departement}', [FlexibleDashboardController::class, 'index'])->middleware('auth:api');
Route::get('/flexibleDashboard/{departement}/prYear/{prYear}', [FlexibleDashboardController::class, 'prYear'])->middleware('auth:api');
Route::get('/flexibleDashboard/{departement}/poYear/{poYear}', [FlexibleDashboardController::class, 'poYear'])->middleware('auth:api');